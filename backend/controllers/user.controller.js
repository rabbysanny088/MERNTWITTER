...
const followUnfollower = async (req, res) => {
  ...
  try {
    ...
    console.log("Error in followUnfollower middleware", error.message);
    return res.status(500).json({ error: error.message });
  }
};
...
const getSuggestedUsers = async (req, res) => {
  ...
  try {
    ...
    console.log("Error in suggestedUsers middleware", error.message);
    return res.status(500).json({ error: error.message });
  }
};
...
const updateUser = async (req, res) => {
  ...
  try {
    ...
    console.log("Error in updateUser middleware", error.message);
    return res.status(500).json({ error: error.message });
  }
};
